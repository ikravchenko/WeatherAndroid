...
public interface BleManagerCallbacks {
	...
	/**
	 * Called when the device has disconnected (when the callback returned {@link android.bluetooth.BluetoothGattCallback#onConnectionStateChange(android.bluetooth.BluetoothGatt, int, int)} with state DISCONNECTED.
	 */
	...
	/**
	 * Called when an {@link android.bluetooth.BluetoothGatt#GATT_INSUFFICIENT_AUTHENTICATION} error occurred and the device bond state is NOT_BONDED
	 */
